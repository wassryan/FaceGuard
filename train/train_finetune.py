...
from dataloader.CASIA_Face_loader_finetune import CASIA_Face
from dataloader.LFW_loader import LFW
from torch.optim import lr_scheduler
import torch.optim as optim
import time
from dataloader.lfw_eval_finetune import parseList, evaluation_10_fold
import numpy as np
import scipy.io
...
for epoch in range(start_epoch, TOTAL_EPOCH+1):
    ...
    _print(loss_msg)
    #writer.add_scalars('loss_train',{'train':train_total_loss},epoch)
    ...
    if epoch % TEST_FREQ == 0:
        ...
        writer.add_scalars('acc_train',{'train':torch.as_tensor(np.mean(accs))},epoch)
