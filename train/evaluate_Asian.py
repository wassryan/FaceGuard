...
def parseList(root):
    with open('pairs_train.txt') as f:
        pairs = f.read().splitlines()
    #folder_name = 'probe_224x224'
    nameLs = []
    nameRs = []
    folds = []
    flags = []
...
if __name__ == '__main__':
    ...
    #parser.add_argument('--lfw_dir', type=str, default='/home/lin/Downloads/', help='The path of lfw data')
    ...
    getFeatureFromTorch(lfw_dir, feature_save_dir, resume)
    ACCs = evaluation_10_fold(feature_save_dir)
