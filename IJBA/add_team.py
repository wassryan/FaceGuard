...
def extract_feat(arch, model_path, yaw_type):
    ...
    type_list = ['gallery/','probe/']
    
    img_dir = '../../data/team/'
    print(img_dir)
    for typ in type_list:
        img_list_file = '../../data/team/' + typ + 'img_name.txt'
        #print(img_list_file)
        #print(type(args.img_dir))
        #img_dataset =  CFPDataset(args.img_dir, img_list_file,
        #        transforms.Compose([caffe_crop,transforms.ToTensor()]))
        img_dataset =  CFPDataset(img_dir, img_list_file,
                transforms.Compose([caffe_crop,transforms.ToTensor()]))
        ...
        img_feat_file = img_dir + 'resnet18_' + typ[:-1] + '_feat.bin'
        #print(img_feat_file)
        feat_dim = 256
...
if __name__ == '__main__':
    ...
    infos = [ ['resnet18_end2end', '/Volumes/FreeAgent G/ijba_res18_end2end.pth.tar', 'nonli'], ]
